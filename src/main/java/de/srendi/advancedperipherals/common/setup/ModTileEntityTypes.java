...
public class ModTileEntityTypes {
    ...
    public static final RegistryObject<TileEntityType<MeBridgeTileEntity>> ME_BRIDGE = Registration.TILE_ENTITIES.register("me_bridge", ()->new TileEntityType<>(MeBridgeTileEntity::new, Sets.newHashSet(ModBlocks.ME_BRIDGE.get()), null));
