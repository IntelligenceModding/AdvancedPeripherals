...
public class CreativeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> AP_CREATIVE_MODE_TAB = Registration.CREATIVE_MODE_TABS.register(AdvancedPeripherals.MOD_ID, CreativeTabs::createCreativeTab);
