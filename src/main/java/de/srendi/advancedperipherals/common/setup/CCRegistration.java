...
public class CCRegistration {
    ...
    public static final DeferredHolder<UpgradeType<? extends IPocketUpgrade>, UpgradeType<PocketChatBoxUpgrade>> DISTANCE_DETECTOR_POCKET = APRegistration.POCKET_SERIALIZER.register(ID.DISTANCE_POCKET.getPath(), () -> UpgradeType.simpleWithCustomItem(PocketDistanceDetectorUpgrade::new));
