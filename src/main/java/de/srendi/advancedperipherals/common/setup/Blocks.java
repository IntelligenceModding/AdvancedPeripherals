...
public class Blocks {
    ...
    public static final RegistryObject<Block> COLONY_INTEGRATOR = register("colony_integrator", BaseBlock::new, () -> new APBlockItem(Blocks.COLONY_INTEGRATOR.get(), null, CCRegistration.ID.COLONY_POCKET, APConfig.PERIPHERALS_CONFIG.enableColonyIntegrator::get));
