...
public class TileEntityTypes {
    ...
    public static final RegistryObject<BlockEntityType<MeBridgeTile>> ME_BRIDGE = ModList.get().isLoaded("appliedenergistics2") ? Registration.TILE_ENTITIES.register("me_bridge", () -> new BlockEntityType<>(MeBridgeTile::new, Sets.newHashSet(Blocks.ME_BRIDGE.get()), null)) : null;
    //public static final RegistryObject<BlockEntityType<RsBridgeTile>> RS_BRIDGE = ModList.get().isLoaded("refinedstorage") ? Registration.TILE_ENTITIES.register("rs_bridge", () -> new BlockEntityType<>(RsBridgeTile::new, Sets.newHashSet(Blocks.RS_BRIDGE.get()), null)) : null;
