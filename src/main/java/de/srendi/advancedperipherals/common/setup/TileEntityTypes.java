...
public class TileEntityTypes {
    ...
    public static final RegistryObject<BlockEntityType<MeBridgeTile>> ME_BRIDGE = ModList.get().isLoaded("ae2") ? Registration.TILE_ENTITIES.register("me_bridge", () -> new BlockEntityType<>(MeBridgeTile::new, Sets.newHashSet(Blocks.ME_BRIDGE.get()), null)) : null;
