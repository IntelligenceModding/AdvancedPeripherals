...
public class APItems {
    ...
    public static final DeferredHolder<Item, APItem>  CABLE_P2P_TUNNEL = APAddons.appliedEnergisticsLoaded ? (DeferredHolder<Item, APItem>) (DeferredHolder<Item, ?>) AE2Registries.CABLE_P2P_TUNNEL : null;
