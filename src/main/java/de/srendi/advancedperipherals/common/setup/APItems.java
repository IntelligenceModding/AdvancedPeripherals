...
public class APItems {
    ...
    public static final RegistryObject<APItem> COMPUTER_TOOL = APRegistration.ITEMS.register("computer_tool", () -> new APItem(new Item.Properties().stacksTo(1), () -> true));
    ...
    public static final RegistryObject<APItem> MEMORY_CARD = APRegistration.ITEMS.register("memory_card", MemoryCardItem::new);

    @DefaultTranslation("Chunk Controller")
    @DefaultTooltip("&7A crafting ingredient for the Chunky Turtle.")
    public static final RegistryObject<APItem> CHUNK_CONTROLLER = APRegistration.ITEMS.register("chunk_controller", () -> new APItem(new Item.Properties().stacksTo(16), APConfig.PERIPHERALS_CONFIG.enableChunkyTurtle));
    @DefaultTranslation("Weak Automata Core")
    @DefaultTooltip("&7Upgrade for turtles, which makes turtles more useful.")
    public static final RegistryObject<APItem> WEAK_AUTOMATA_CORE = APRegistration.ITEMS.register("weak_automata_core", () -> new WeakAutomataCore(new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<APItem> OVERPOWERED_WEAK_AUTOMATA_CORE = APRegistration.ITEMS.register("overpowered_weak_automata_core", () -> new APItem(new Item.Properties().stacksTo(1), APConfig.METAPHYSICS_CONFIG.enableWeakAutomataCore));
    ...
    public static final RegistryObject<APItem> HUSBANDRY_AUTOMATA_CORE = APRegistration.ITEMS.register("husbandry_automata_core", () -> new APItem(new Item.Properties().stacksTo(1), APConfig.METAPHYSICS_CONFIG.enableHusbandryAutomataCore));
    ...
    public static final RegistryObject<APItem> OVERPOWERED_HUSBANDRY_AUTOMATA_CORE = APRegistration.ITEMS.register("overpowered_husbandry_automata_core", () -> new APItem(new Item.Properties().stacksTo(1), APConfig.METAPHYSICS_CONFIG.enableHusbandryAutomataCore));
    ...
    public static final RegistryObject<APItem> END_AUTOMATA_CORE = APRegistration.ITEMS.register("end_automata_core", () -> new APItem(new Item.Properties().stacksTo(1), APConfig.METAPHYSICS_CONFIG.enableEndAutomataCore));
    ...
    public static final RegistryObject<APItem> OVERPOWERED_END_AUTOMATA_CORE = APRegistration.ITEMS.register("overpowered_end_automata_core", () -> new APItem(new Item.Properties().stacksTo(1), APConfig.METAPHYSICS_CONFIG.enableEndAutomataCore));
    ...
    public static final RegistryObject<APItem> CABLE_P2P_TUNNEL = APAddon.AE2.isLoaded() ? (RegistryObject<APItem>) (RegistryObject<?>) AE2Registries.CABLE_P2P_TUNNEL : null;
    @DefaultTranslation("AE Disk Cell 1M")
    @DefaultTooltip("&7Provides a bit external file storage via ME Bridge.")
    public static final RegistryObject<AEDiskCellItem> AE_DISK_CELL_1M = APAddon.AE2.isLoaded() ? APRegistration.ITEMS.register("ae_disk_cell_1m", () -> new AEDiskCellItem(new Item.Properties(), AEDiskCellItem.Tier.DISK_1M)) : null;
    @DefaultTranslation("AE Disk Cell 4M")
    @DefaultTooltip("&7Provides some external file storage via ME Bridge.")
    public static final RegistryObject<AEDiskCellItem> AE_DISK_CELL_4M = APAddon.AE2.isLoaded() ? APRegistration.ITEMS.register("ae_disk_cell_4m", () -> new AEDiskCellItem(new Item.Properties(), AEDiskCellItem.Tier.DISK_4M)) : null;
    @DefaultTranslation("AE Disk Cell 16M")
    @DefaultTooltip("&7Provides some more external file storage via ME Bridge.")
    public static final RegistryObject<AEDiskCellItem> AE_DISK_CELL_16M = APAddon.AE2.isLoaded() ? APRegistration.ITEMS.register("ae_disk_cell_16m", () -> new AEDiskCellItem(new Item.Properties(), AEDiskCellItem.Tier.DISK_16M)) : null;
    @DefaultTranslation("AE Disk Cell 64M")
    @DefaultTooltip("&7Provides even more external file storage via ME Bridge.")
    public static final RegistryObject<AEDiskCellItem> AE_DISK_CELL_64M = APAddon.AE2.isLoaded() ? APRegistration.ITEMS.register("ae_disk_cell_64m", () -> new AEDiskCellItem(new Item.Properties(), AEDiskCellItem.Tier.DISK_64M)) : null;
