...
public class VillagerTrades {
    ...
    public static void registerWanderingTrade(WandererTradesEvent event) {
        ...
        event.getRareTrades().add(new VillagerTrade(VillagerTrade.Type.EMERALD_FOR_ITEM).setItem(Registry.ModBlocks.TURTLE_ADVANCED.get()).setEmeraldPrice(2).setMaxUses(4).setXp(20).setItemAmount(1));
    }
    ...
    public static void registerVillagerTrades(VillagerTradesEvent event) {
        ...
        if (event.getType() == Villagers.COMPUTER_SCIENTIST.get()) {
            ...
            trades.get(1).add(new VillagerTrade(VillagerTrade.Type.ITEM_FOR_EMERALD).setItem(Registry.ModBlocks.COMPUTER_NORMAL.get()).setEmeraldPrice(1).setMaxUses(8).setXp(4));
            ...
            trades.get(2).add(new VillagerTrade(VillagerTrade.Type.ITEM_FOR_EMERALD).setItem(Registry.ModBlocks.COMPUTER_ADVANCED.get()).setEmeraldPrice(2).setMaxUses(3).setXp(10));
            trades.get(2).add(new VillagerTrade(VillagerTrade.Type.ITEM_FOR_EMERALD).setItem(Registry.ModBlocks.MONITOR_NORMAL.get()).setEmeraldPrice(1).setMaxUses(8).setXp(6).setItemAmount(8));
            ...
            trades.get(3).add(new VillagerTrade(VillagerTrade.Type.ITEM_FOR_EMERALD).setItem(Registry.ModBlocks.MONITOR_ADVANCED.get()).setEmeraldPrice(6).setMaxUses(8).setXp(10).setItemAmount(16));
            ...
            trades.get(4).add(new VillagerTrade(VillagerTrade.Type.EMERALD_FOR_ITEM).setItem(Registry.ModBlocks.COMPUTER_ADVANCED.get()).setEmeraldPrice(2).setMaxUses(8).setXp(12));
            ...
            trades.get(4).add(new VillagerTrade(VillagerTrade.Type.EMERALD_FOR_ITEM).setItem(Registry.ModItems.PRINTED_PAGE.get()).setEmeraldPrice(1).setMaxUses(10).setXp(16).setItemAmount(4));
            ...
            trades.get(5).add(new VillagerTrade(VillagerTrade.Type.EMERALD_FOR_ITEM).setItem(Registry.ModBlocks.WIRELESS_MODEM_ADVANCED.get()).setEmeraldPrice(2).setMaxUses(14).setXp(30));
