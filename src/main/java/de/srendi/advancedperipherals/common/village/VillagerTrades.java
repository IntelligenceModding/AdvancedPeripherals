...
public class VillagerTrades {
    ...
    public static void registerWanderingTrade(WandererTradesEvent event) {
        event.getGenericTrades().add(new VillagerTrade(VillagerTrade.Type.ITEM_FOR_EMERALD).setItem(APBlocks.PERIPHERAL_CASING.get()).setEmeraldPrice(1).setMaxUses(16).setXp(3));
    ...
    public static void registerVillagerTrades(VillagerTradesEvent event) {
        ...
        if (event.getType() == APVillagers.COMPUTER_SCIENTIST.get()) {
            ...
            trades.get(1).add(new VillagerTrade(VillagerTrade.Type.ITEM_FOR_EMERALD).setItem(APBlocks.PERIPHERAL_CASING.get()).setEmeraldPrice(2).setMaxUses(10).setXp(4));
            trades.get(1).add(new VillagerTrade(VillagerTrade.Type.ITEM_FOR_EMERALD).setItem(APBlocks.CHAT_BOX.get()).setEmeraldPrice(2).setMaxUses(8).setXp(4));
            ...
            trades.get(1).add(new VillagerTrade(VillagerTrade.Type.EMERALD_FOR_ITEM).setItem(APBlocks.PERIPHERAL_CASING.get()).setEmeraldPrice(1).setMaxUses(8).setXp(2));

            trades.get(2).add(new VillagerTrade(VillagerTrade.Type.ITEM_FOR_EMERALD).setItem(APBlocks.INVENTORY_MANAGER.get()).setEmeraldPrice(2).setMaxUses(2).setXp(8));
            trades.get(2).add(new VillagerTrade(VillagerTrade.Type.ITEM_FOR_EMERALD).setItem(APBlocks.REDSTONE_INTEGRATOR.get()).setEmeraldPrice(2).setMaxUses(2).setXp(8));
            ...
            trades.get(3).add(new VillagerTrade(VillagerTrade.Type.EMERALD_FOR_ITEM).setItem(APItems.CHUNK_CONTROLLER.get()).setEmeraldPrice(1).setMaxUses(6).setXp(8));
            trades.get(3).add(new VillagerTrade(VillagerTrade.Type.ITEM_FOR_EMERALD).setItem(APItems.COMPUTER_TOOL.get()).setEmeraldPrice(1).setMaxUses(4).setXp(8));
            ...
            trades.get(4).add(new VillagerTrade(VillagerTrade.Type.ITEM_FOR_EMERALD).setItem(APBlocks.ENERGY_DETECTOR.get()).setEmeraldPrice(3).setMaxUses(8).setXp(12));
            ...
            trades.get(4).add(new VillagerTrade(VillagerTrade.Type.ITEM_FOR_EMERALD).setItem(APItems.MEMORY_CARD.get()).setEmeraldPrice(1).setMaxUses(8).setXp(18));
            ...
            trades.get(5).add(new VillagerTrade(VillagerTrade.Type.ITEM_FOR_EMERALD).setItem(APBlocks.AR_CONTROLLER.get()).setEmeraldPrice(3).setMaxUses(6).setXp(30));
            trades.get(5).add(new VillagerTrade(VillagerTrade.Type.ITEM_FOR_EMERALD).setItem(APItems.SMART_GLASSES.get()).setEmeraldPrice(4).setMaxUses(8).setXp(30));
