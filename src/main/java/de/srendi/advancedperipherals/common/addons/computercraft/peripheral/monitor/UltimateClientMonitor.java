...
public final class UltimateClientMonitor
{
    private static final Set<UltimateClientMonitor> allMonitors = new HashSet<>();
    ...
    private UltimateNetworkedTerminal terminal;
    private boolean terminalChanged;

    public UltimateClientMonitor( UltimateMonitorEntity origin )
    {
        this.origin = origin;
    }

    public UltimateMonitorEntity getOrigin()
    {
        return origin;
    }
    ...
    public static void destroyAll()
    {
        synchronized( allMonitors )
        {
            for( Iterator<UltimateClientMonitor> iterator = allMonitors.iterator(); iterator.hasNext(); )
            {
                UltimateClientMonitor monitor = iterator.next();
    ...
    void read( TerminalState state )
    {
        ...
        {
            if( terminal == null ) terminal = new UltimateNetworkedTerminal( state.width, state.height );
