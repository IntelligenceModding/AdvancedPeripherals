 ...
 * states, etc...
 */
public class UltimateTerminalState
{
    ...
    public UltimateTerminalState( @Nullable UltimateNetworkedTerminal terminal )
    {
        this( terminal, true );
    }

    public UltimateTerminalState( @Nullable UltimateNetworkedTerminal terminal, boolean compress )
    {
    ...
    public UltimateTerminalState( FriendlyByteBuf buf )
    {
        buf.readBoolean();
    ...
    public void apply( UltimateNetworkedTerminal terminal )
    {
    ...
    public UltimateNetworkedTerminal create()
    {
        if( buffer == null ) throw new NullPointerException( "Terminal does not exist" );
        UltimateNetworkedTerminal terminal = new UltimateNetworkedTerminal( width, height );
        terminal.read( new FriendlyByteBuf( buffer ) );
        return terminal;
    }
