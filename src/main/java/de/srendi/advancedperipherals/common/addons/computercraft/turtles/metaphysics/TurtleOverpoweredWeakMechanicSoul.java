...
public class TurtleOverpoweredWeakMechanicSoul extends ModelTransformingTurtle<OverpoweredWeakMechanicSoulPeripheral> {
    ...
    @Override
    protected OverpoweredWeakMechanicSoulPeripheral buildPeripheral(@NotNull ITurtleAccess turtle, @NotNull TurtleSide side) {
        return new OverpoweredWeakMechanicSoulPeripheral("overpoweredWeakMechanicSoul", turtle, side);
    }
}
