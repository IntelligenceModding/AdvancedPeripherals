...
public class RecipesProvider extends RecipeProvider implements IConditionBuilder {
    ...
    private void addShaped(@NotNull Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, APBlocks.PERIPHERAL_CASING.get())
                .define('I', Tags.Items.INGOTS_IRON)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, APBlocks.REDSTONE_INTEGRATOR.get())
                .define('R', Tags.Items.STORAGE_BLOCKS_REDSTONE)
                .define('A', CASING)
                .define('C', Items.COMPARATOR)
                .pattern("RCR")
...
*/
    ...
    private void addSmithing(@NotNull Consumer<FinishedRecipe> consumer) {
        UpgradeRecipeBuilder
                .smithing(Ingredient.of(APItems.SMART_GLASSES.get()), Ingredient.of(Items.NETHERITE_INGOT), RecipeCategory.REDSTONE, APItems.SMART_GLASSES_NETHERITE.get())
