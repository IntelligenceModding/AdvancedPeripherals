...
public class ItemFilter extends GenericFilter {
    ...
    public boolean test(ItemStack stack) {
        ...
        // If the filter does not have nbt values, a tag or a fingerprint, just test if
    ...
    public String toString() {
        return "ItemFilter{" + "item=" + ItemUtil.getRegistryKey(item) + ", tag=" + tag + ", nbt=" + nbt + ", count="
                + count + ", fingerprint='" + fingerprint + '\'' + ", fromSlot=" + fromSlot + ", toSlot=" + toSlot
                + '}';
    }
}
