...
public class PeripheralsConfig implements IAPConfig {
    ...
    public PeripheralsConfig() {
        ...
        enablePlayerDetector = builder.comment("Enable the Player Detector or not.").define("enablePlayerDetector",
                true);
        playerDetMaxRange = builder.comment(
        ...
        playerSpy = builder.comment("Activates the \"getPlayerPos\" function of the Player Detector")
        ...
        playerDetMultiDimensional = builder.comment(
        ...
        playerSpyRandError = builder.comment(
        ...
        playerSpyRandErrorAmount = builder.comment(
        ...
        playerSpyPreciseMaxRange = builder.comment(
        ...
        enableEnergyDetector = builder.comment("Enable the Energy Detector or not.").define("enableEnergyDetector",
                true);
        energyDetectorMaxFlow = builder.comment("Defines the maximum energy flow of the energy detector.")
        ...
        fluidDetectorMaxFlow = builder.comment("Defines the maximum fluid flow of the fluid detector.")
                .defineInRange("energyDetectorMaxFlow", Integer.MAX_VALUE, 0, Integer.MAX_VALUE);

        pop("Gas_Detector", builder);

        enableGasDetector = builder.comment("Enable the Gas Detector or not.").define("enableGasDetector", true);
        gasDetectorMaxFlow = builder.comment("Defines the maximum gas flow of the gas detector.")
        ...
        nbtStorageMaxSize = builder.comment("Defines max nbt string length that can be stored in nbt storage")
        ...
        chunkyTurtleRadius = builder.comment(
        ...
        chatBoxMaxRange = builder.comment(
        ...
        meConsumption = builder.comment("Power consumption per tick.").defineInRange("mePowerConsumption", 10, 0,
                Integer.MAX_VALUE);

        pop("RS_Bridge", builder);
        enableRSBridge = builder.comment("Enable the Rs Bridge or not.").define("enableRsBridge", true);
        rsConsumption = builder.comment("Power consumption per tick.").defineInRange("rsPowerConsumption", 10, 0,
                Integer.MAX_VALUE);

        pop("Environment_Detector", builder);

        enableEnvironmentDetector = builder.comment("Enable the Environment Detector or not.")
        ...
        enableInventoryManager = builder.comment("Enable the inventory manager or not.")
                .define("enableInventoryManager", true);

        pop("Redstone_Integrator", builder);

        enableRedstoneIntegrator = builder.comment("Enable the redstone integrator or not.")
        ...
        enableColonyIntegrator = builder.comment("Enable the colony integrator or not.")
        ...
        enableDistanceDetector = builder.comment("Enable the distance detector or not.")
                .define("enableDistanceDetector", true);
        distanceDetectorRange = builder.comment("Maximum range of the distance detector")
                .defineInRange("distanceDetectorRange", 64D, 0D, Integer.MAX_VALUE);
        distanceDetectorUpdateRate = builder.comment(
                "Defines how often the distance detector updates it's distance if periodically updates are enabled. \n"
        ...
        enablePoweredPeripherals = builder.comment("Enable RF storage for peripherals, that could use it")
                .define("enablePoweredPeripherals", false);
        poweredPeripheralMaxEnergyStorage = builder.comment("Defines max energy storage in any powered peripheral")
                .defineInRange("poweredPeripheralMaxEnergyStored", 100_000_000, 1_000_000, Integer.MAX_VALUE);

        pop("Pocket_Peripherals", builder);

        disablePocketFuelConsumption = builder.comment("If true, pockets will have infinite fuel")
