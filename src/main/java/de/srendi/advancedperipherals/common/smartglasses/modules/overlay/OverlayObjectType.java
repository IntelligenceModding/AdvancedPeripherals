...
public class OverlayObjectType<T extends OverlayObject> {
    ...
    private final IObjectRenderer renderer;

    public OverlayObjectType(Function<OverlayModule, @NotNull T> serverFactory, Function<UUID, @NotNull T> clientFactory, IObjectRenderer renderer) {
