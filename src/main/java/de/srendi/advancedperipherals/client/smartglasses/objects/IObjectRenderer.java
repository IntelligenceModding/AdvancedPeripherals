...
public interface IObjectRenderer<O extends OverlayObject> {
    void render2D(List<O> batch, GuiGraphics gui, float partialTick);
    ...
    static void apply3DTransforms(PoseStack poseStack, RenderableObject obj, float partialTick, Vec3 eyePos, Quaternionf eyeRotation) {
    ...
    static void apply3DTransforms(Matrix4f mat, RenderableObject obj, float partialTick, Vec3 eyePos, Quaternionf eyeRotation) {
        if (obj.relativePosition) {
