 ...
 */
package de.srendi.advancedperipherals.client.renderer.text;
...
public final class DirectFixedWidthFontRenderer
{
    ...
    private static void drawChar( QuadEmitter emitter, float x, float y, int index, byte[] colour, int alpha )
    {
